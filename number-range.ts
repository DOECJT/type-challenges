...
type NumberRange<Start extends number, End extends number, C extends 0[] = NumberToArray<Start>, A extends unknown[] = [Start]> =
  C['length'] extends End
    ? A[number]
    : NumberRange<Start, End, [...C, 0], [...A, [...C, 0]['length']]>

type Test<T extends 0[] = []> = [...T, 0]['length']
type A = Test
