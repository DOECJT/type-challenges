...
type UnionCombinations<U extends string, C extends string = U> =
  U extends U
    ? U | `${U}${UnionCombinations<Exclude<C, U>>}`
    : never
type B = UnionCombinations<'A' | 'B' | 'C'>
...
type AllCombinations<
  ...
  C extends string = U
> = U extends U
  ? U | `${U}${AllCombinations<T, Exclude<C, U>>}`
  : never
